...
<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
    <div class="row">
        <ol class="breadcrumb">
            ...
            <li class="active">{{%Edit short address%}}</li>
        </ol>
    </div><!--/.row-->
    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <div class="panel-body">
                ...
                <form action="/navigation/pretty/update/id=<?=$id?>" method="post">
                    <fieldset>
                        <div class="form-group">
                            <label><?=$model->labels('model')?></label>
                            <p>
                                <?=$modules[$model->values('model')]['name']?>
                            </p>
                        </div>
