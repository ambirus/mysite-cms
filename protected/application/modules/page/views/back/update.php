...
<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
    <div class="row">
        <ol class="breadcrumb">
            ...
            <li class="active">{{%Editing the page%}} &laquo;<?=$model->values('title')?>&raquo;</li>
        </ol>
    </div><!--/.row-->
    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <h1 class="page-header">{{%Page%}} &laquo;<?=$model->values('title')?>&raquo;</h1>
            ...
            <div class="panel-body">
                ...
                <form role="form" action="/page/back/update/id=<?=$model->values('id')?>" method="post">
                    <fieldset>
